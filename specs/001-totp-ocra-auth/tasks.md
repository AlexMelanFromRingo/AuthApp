...
- [x] T025 [US2] Розгорнути на GitHub Pages (workflow з T006), перевірити сценарії 2 і 6 quickstart.md у Chrome та Firefox (SC-004, SC-008), зафіксувати в `specs/001-totp-ocra-auth/checklists/us2-validation.md`
...
- [x] T040 [P] Локалізаційна вичитка (FR-024): усі strings.xml, тексти стенду, логи і коментарі обох кодових баз — виключно українською
- [x] T041 [P] Створити довідкову сторінку `web-stand/src/pages/about.js`: опис 7 алгоритмів, узагальненого усічення і протоколу OCRA з посиланнями на RFC — матеріал для захисту диплома
- [x] T042 Оновити кореневий `README.md`: інструкції збірки обох частин, посилання на quickstart.md і живий стенд на Pages
